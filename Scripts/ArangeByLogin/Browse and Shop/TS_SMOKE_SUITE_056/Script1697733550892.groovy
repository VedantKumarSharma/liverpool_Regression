...
WebUI.callTestCase(findTestCase('CommonMethodsSmoke/SearchForAProduct_search'), [('searchTerm') : 'pantalon'], FailureHandling.STOP_ON_FAILURE)

//a = CustomKeywords.'a.GenerateRandomEmail.generateRandomEmail'()

//System.out.println(a)

WebUI.click(findTestObject('SmokeSuitObjects/PLPPage/product-2-DiscountPrice_PLP'))

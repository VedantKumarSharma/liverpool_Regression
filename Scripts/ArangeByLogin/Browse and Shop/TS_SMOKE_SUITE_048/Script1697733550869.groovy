...
'verify price range\r\n'
a = WebUI.getText(findTestObject('SmokeSuitObjects/PLPPage/product1_cardPrice_PLP'))

'verify price range\r\n'
b = WebUI.getText(findTestObject('SmokeSuitObjects/PLPPage/product-1-DiscountPrice_PLP'))

...
WebUI.callTestCase(findTestCase('CommonMethodsSmoke/SearchForAProduct_search'), [('searchTerm') : 'sam'], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('SmokeSuitObjects/PLPPage/product-1-DiscountPrice_PLP'))
...
WebUI.click(findTestObject('SmokeSuitObjects/OPCPage/paymentMethod_button3_OPC'))

WebUI.click(findTestObject('SmokeSuitObjects/OPCPage/Continue_payment_3rdmethod_OPC'))

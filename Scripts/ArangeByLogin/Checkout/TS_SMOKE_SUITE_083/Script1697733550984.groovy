...
WebUI.setText(findTestObject('SmokeSuitObjects/OPCPage/enterCardExpire_OPC'), '1225')

WebUI.setText(findTestObject('SmokeSuitObjects/OPCPage/enterCardCVV_OPC'), '805')

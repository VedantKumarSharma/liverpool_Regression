...
WebUI.click(findTestObject('SmokeSuitObjects/PLPPage/product-3-DiscountPrice_PLP'), FailureHandling.OPTIONAL)
...
WebUI.callTestCase(findTestCase('CommonMethodsSmoke/assert_OPC(CheckoutPage)'), [:], FailureHandling.STOP_ON_FAILURE)

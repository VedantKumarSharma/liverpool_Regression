...
WebUI.click(findTestObject('SmokeSuitObjects/PLPPage/product-2-DiscountPrice_PLP'), FailureHandling.OPTIONAL)
...
WebUI.callTestCase(findTestCase('CommonMethodsSmoke/create_new_CARD_OPC'), [:], FailureHandling.STOP_ON_FAILURE)

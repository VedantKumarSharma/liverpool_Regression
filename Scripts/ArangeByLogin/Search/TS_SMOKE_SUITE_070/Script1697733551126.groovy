...
WebUI.scrollToElement(findTestObject('SmokeSuitObjects/PLPPage/ForwardArrow_Pagenation_PLP'), 0)

WebUI.click(findTestObject('SmokeSuitObjects/PLPPage/ForwardArrow_Pagenation_PLP'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.scrollToElement(findTestObject('SmokeSuitObjects/PLPPage/BackArrow_Pagenation_PLP'), 0)

WebUI.click(findTestObject('SmokeSuitObjects/PLPPage/BackArrow_Pagenation_PLP'), FailureHandling.STOP_ON_FAILURE)

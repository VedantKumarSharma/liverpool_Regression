...
WebUI.callTestCase(findTestCase('CommonMethodsSmoke/SearchForAProduct_search'), [('searchTerm') : '1031144554'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('SmokeSuitObjects/OPCPage/changeADDRESS_OPC'))

WebUI.click(findTestObject('SmokeSuitObjects/OPCPage/clickAndCollect_OPC'))

WebUI.verifyElementPresent(findTestObject('SmokeSuitObjects/OPCPage/SeleccionUNA_Tienda(CNC)_OPC'), 0)

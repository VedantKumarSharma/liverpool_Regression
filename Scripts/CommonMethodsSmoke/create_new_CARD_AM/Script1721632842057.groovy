...
WebUI.setText(findTestObject('SmokeSuitObjects/OPCPage/cellphone_addAddress_opc'), GlobalVariable.CellPhoneAddAddress, FailureHandling.OPTIONAL)

WebUI.setText(findTestObject('SmokeSuitObjects/OPCPage/LADA_addAddress_opc'), GlobalVariable.LADAaddAddress, FailureHandling.OPTIONAL)

WebUI.setText(findTestObject('SmokeSuitObjects/OPCPage/phone_addAddress_opc'), GlobalVariable.phoneAddAddress, FailureHandling.OPTIONAL)

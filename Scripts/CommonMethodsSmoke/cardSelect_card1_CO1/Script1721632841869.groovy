...
WebUI.click(findTestObject('SmokeSuitObjects/OPCPage/selectCard1Option_cardpopup_OPC'))

WebUI.delay(1)

WebUI.setText(findTestObject('SmokeSuitObjects/OPCPage/enterCardExpire_OPC'), '12/24')

WebUI.setText(findTestObject('SmokeSuitObjects/OPCPage/enterCardCVV_OPC'), '123')

WebUI.enhancedClick(findTestObject('SmokeSuitObjects/OPCPage/cardContinue_checkout_popUP'))

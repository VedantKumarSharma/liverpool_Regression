...
WebUI.setText(findTestObject('SmokeSuitObjects/OPCPage/postalCode_addAddress_opc'), GlobalVariable.PostalCode)

WebUI.setText(findTestObject('SmokeSuitObjects/OPCPage/city_addAddress_opc'), GlobalVariable.CityAddAddress)

WebUI.click(findTestObject('SmokeSuitObjects/OPCPage/street_addAddress_opc'))
...
WebUI.click(findTestObject('SmokeSuitObjects/OPCPage/CheckBoxAddAddressPopup_OPC'))

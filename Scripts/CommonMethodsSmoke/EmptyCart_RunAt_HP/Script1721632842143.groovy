...
WebUI.click(findTestObject('SmokeSuitObjects/HomePage/bag_header_HP'), FailureHandling.OPTIONAL)

List<WebElement> listElement = WebUI.findWebElements(findTestObject('SmokeSuitObjects/CartPage/Product1_remove_cart'),2)
...
for (int i = 0; i < noOfProducts; i++) {
    ...
    WebUI.click(findTestObject('SmokeSuitObjects/CartPage/Product1_remove_cart'))
...
WebUI.click(findTestObject('SmokeSuitObjects/HomePage/Logo_hp'), FailureHandling.OPTIONAL)

...
WebUI.callTestCase(findTestCase('CommonMethodsSmoke/clickIniciarSession_Header'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('CommonMethodsSmoke/loginFromHomePage'), [('username') : 'UN85@digisprint.com', ('password') : 'Un85@12345'], 
...
not_run: WebUI.verifyElementPresent(findTestObject('SmokeSuitObjects/CLPPage/breadCrumb_clp'), 0)
...
WebUI.callTestCase(findTestCase('CommonMethodsSmoke/SearchForAProduct_search'), [('searchTerm') : 'vaso'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('SmokeSuitObjects/OPCPage/deliveryAddressHeading_address_opc'), 0)

WebUI.verifyElementPresent(findTestObject('SmokeSuitObjects/OPCPage/label_Cambiar_Address_opc'), 0)

WebUI.verifyElementPresent(findTestObject('SmokeSuitObjects/OPCPage/Forma de Pago_payment_opc'), 0)

WebUI.verifyElementPresent(findTestObject('SmokeSuitObjects/OPCPage/paymentSection_payment_opc'), 0)

WebUI.verifyElementPresent(findTestObject('SmokeSuitObjects/OPCPage/label_Cambiar_payment_opc'), 0)

WebUI.verifyElementPresent(findTestObject('checkoutpage/productSection_opc'), 0)

WebUI.verifyElementPresent(findTestObject('SmokeSuitObjects/OPCPage/productImage_opc'), 0)
...
WebUI.verifyElementPresent(findTestObject('SmokeSuitObjects/OPCPage/promotionSection_opc'), 0)
...
WebUI.verifyElementPresent(findTestObject('SmokeSuitObjects/OPCPage/button_Cupones_opc'), 0)

WebUI.click(findTestObject('SmokeSuitObjects/OPCPage/label_Cambiar_payment_opc'))

WebUI.click(findTestObject('SmokeSuitObjects/OPCPage/button_Efectivo y Transferencias_payment_opc (1)'))
...
WebUI.click(findTestObject('SmokeSuitObjects/OPCPage/button_Finalizar compra_opc'))

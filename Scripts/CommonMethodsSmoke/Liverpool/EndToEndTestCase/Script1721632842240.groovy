...
WebUI.callTestCase(findTestCase('CommonMethodsSmoke/loginFromHomePage'), [('username') : GlobalVariable.Username, ('password') : GlobalVariable.Password], 
    FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.verifyElementPresent(findTestObject('SmokeSuitObjects/HomePage/Iniciar sesion'), 0)
...
not_run: WebUI.click(findTestObject('SmokeSuitObjects/OPCPage/button_Continuar_payment_opc'))

WebUI.click(findTestObject('SmokeSuitObjects/OPCPage/button_Continuar_payment_opc'))

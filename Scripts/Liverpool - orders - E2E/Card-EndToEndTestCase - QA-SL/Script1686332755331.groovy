...
WebUI.verifyElementPresent(findTestObject('PLPPage/div_Vendido por_plp'), 0)
...
WebUI.verifyElementPresent(findTestObject('PLPPage/a_Color_variants-normalizedColor-Blanco_plp'), 0)
